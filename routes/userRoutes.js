...
router.post("/request-email-verification-code", protect, requestEmailVerificationCode);
router.post("/request-mobile-verification-code", protect, requestMobileVerificationCode);
